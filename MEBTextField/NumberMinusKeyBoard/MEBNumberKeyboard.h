...
//! Project version number for MEBNumberKeyboard.
FOUNDATION_EXPORT double MEBNumberKeyboardVersionNumber;

//! Project version string for MEBNumberKeyboard.
FOUNDATION_EXPORT const unsigned char MEBNumberKeyboardVersionString[];

@class MEBNumberKeyboard;

/**
 *  The @c MEBNumberKeyboardDelegate protocol defines the messages sent to a delegate object as part of the sequence of editing text. All of the methods of this protocol are optional.
 */
@protocol MEBNumberKeyboardDelegate <NSObject>
@optional
 ...
 */
- (BOOL)numberKeyboardShouldReturn:(MEBNumberKeyboard *)numberKeyboard;
 ...
 */
- (BOOL)numberKeyboardShouldDeleteBackward:(MEBNumberKeyboard *)numberKeyboard;
 ...
 */
typedef NS_ENUM(NSUInteger, MEBNumberKeyboardStyle) {
    /**
     ...
     */
    MEBNumberKeyboardStyleAutomatic,
     ...
     */
    MEBNumberKeyboardStylePlainButtons,
 ...
 */
@property (weak, nonatomic) id <MEBNumberKeyboardDelegate> delegate;
 ...
 *
 *  @note The default style for the keyboard is @c MEBNumberKeyboardStyleAutomatic.
 */
@property (assign, nonatomic) MEBNumberKeyboardStyle preferredStyle;

/**
 *  The button style of the Return key.
 *
 *  @note The default value of this property is @c MEBNumberKeyboardButtonStyleDone.
 */
@property (assign, nonatomic) MEBNumberKeyboardButtonStyle returnKeyButtonStyle;
